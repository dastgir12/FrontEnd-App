...
const FeedbackCard = ({ content , name , title , img}) => {
  return (
    <div className='flex flex-col justify-between px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 feedback-card my-5'>
      <img src={quotes} alt="quotes"  className='max-w-[47px] h-[27px] object-contain '/>
      <p className=' font-poppins font-normal text-[18px] my-10 leading-[32px] text-white'>{content}</p>
